...
module.exports.onLoad = (o) => {
    if (!!global.autosendmessage_setinterval)
        clearInterval(global.autosendmessage_setinterval);
    ...
    switch (action) {
        ...
        case "test":
            if (!data[threadID].enabled)
                return api.sendMessage(
                    "⚠️ Autosend hiện đang tắt trong nhóm này. Bật bằng lệnh: autosend on",
                    threadID,
                    messageID,
                );
